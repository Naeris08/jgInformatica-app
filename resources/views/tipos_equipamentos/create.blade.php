            ...
            <div class="bg-slate-800/40 border border-slate-700 p-8 rounded-3xl shadow-2xl backdrop-blur-sm">
                ...
                <form action="{{ route('tipos_equipamentos.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" required class="w-full bg-slate-900/50 border border-slate-700 text-slate-100 rounded-2xl px-4 py-3 focus:ring-indigo-500 focus:border-indigo-500" />
                    </div>
